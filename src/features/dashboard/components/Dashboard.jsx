      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="relative md:col-span-7 rounded-[32px] overflow-hidden group bg-white shadow-xl h-[450px] md:h-[550px] flex flex-col justify-end border border-gray-100"
          >
            <img 
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="relative md:col-span-5 rounded-[32px] overflow-hidden group bg-white shadow-xl h-[450px] md:h-[550px] flex flex-col justify-start border border-gray-100"
          >
            <img 
            ...
            <div className="relative z-10 p-8 md:p-12 text-center flex flex-col items-center pt-16">
              ...
              <h3 className="text-3xl md:text-4xl font-bold mb-4 text-white">24/7 Doctor <br/> Consultation</h3>
          ...
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="relative md:col-span-12 rounded-[32px] overflow-hidden group shadow-xl h-[400px] flex items-center border border-gray-100"
          >
            <img 
            ...
            <div className="relative z-10 p-8 md:p-16 flex flex-col items-start max-w-lg">
              ...
              <h3 className="text-3xl md:text-5xl font-bold mb-4 text-white">Diagnostic <br/> Labs</h3>
