...
function Pricing() {
  ...
  return (
    <section className="relative px-6 md:px-20 py-24 text-center bg-[#f4f8f9] text-gray-800">
      ...
      >
        <div className="w-full h-full bg-[radial-gradient(circle_at_center,rgba(0,150,136,0.06),rgba(255,255,255,0.95))]"></div>
      </motion.div>
            ...
            <InteractiveCard>
              <motion.div
                className={`relative p-8 rounded-3xl transition-all duration-500 ${
                  plan.highlight
                    ? "bg-white border border-teal-400 shadow-xl"
              ...
              >
                {plan.highlight && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-teal-500 text-white text-xs px-4 py-1 rounded-full shadow-md">
                    MOST POPULAR
                  </div>
                )}
                ...
                <div className="mt-8">
                  <button
                    onClick={() => handleSubscribe(plan)} // ✅ Added
                    className="w-full bg-teal-500 text-white px-6 py-3 rounded-lg hover:bg-teal-600 transition font-semibold"
                  >
                    Choose Plan
                  </button>
                </div>
