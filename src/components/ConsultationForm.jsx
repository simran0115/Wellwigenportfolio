...
const ConsultationForm = () => {
    ...
    return (
        <section id="book" className="py-24 bg-gradient-to-b from-light to-white relative overflow-hidden">
            {/* Decorative Blobs */}
                    ...
                    <form className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-2">
                                ...
                                <input type="text" className="w-full px-4 py-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter your full name" required />
                            </div>
                            <div className="space-y-2">
                                ...
                                <div className="flex">
                                    ...
                                    <input type="tel" className="w-full px-4 py-4 rounded-r-xl bg-gray-50 border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="10-digit mobile number" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-2">
                                ...
                                <input type="email" className="w-full px-4 py-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="your.email@example.com" />
                            </div>
                            <div className="space-y-2">
                                <label className="block text-sm font-bold text-dark uppercase tracking-wider">Gender*</label>
                                <select className="w-full px-4 py-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none" required>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                maxLength={500}
                            ></textarea>
                            <div className="text-right text-xs text-gray-400">0/500</div>
                        </div>

                        {/* Terms */}
                        <div className="flex items-start gap-3">
                            <div className="flex items-center h-5">
                                <input id="terms" type="checkbox" className="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary" required />
                            </div>
                            <label htmlFor="terms" className="text-sm text-gray-500">
                                I agree to be contacted by Wellwigen Fitness and understand my details may be used to respond to this enquiry. <a href="#" className="text-primary hover:underline">Terms & Conditions</a>
                            </label>
                        </div>

                        <button type="submit" className="w-full bg-dark text-white font-bold py-5 rounded-xl hover:bg-opacity-90 transition-all transform hover:scale-[1.01] shadow-xl text-lg flex items-center justify-center gap-2 group">
